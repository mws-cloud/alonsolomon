-- ============================================================
-- הקמה חד-פעמית לדף הנחיתה "תכנית שכר טרחת מינימום" + פאנל הניהול
-- להריץ ב-SQL Editor של פרויקט ה-Supabase של האתר (emkrjhmlorbjqaltivpo)
...
-- עדכון updated_at אוטומטי (משתמש בפונקציה הקיימת של האתר).
